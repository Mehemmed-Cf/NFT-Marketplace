...
document.addEventListener("DOMContentLoaded", function () {
    ...
    if (storedSearchTerm) {
        ...
        Search_Input.value = storedSearchTerm;
...
async function getDataForNFTs() {
    ...
    const response = await fetch("/Marketplace/GetNfts", {
        method: "POST",
        headers: {
...
async function fetchSearchResults(searchTerm) {
    ...
    try {
        ...
        fillNFTMarketplace({ nfts: filteredNfts });
    } catch (error) {
...
//    const response = await fetch("/Marketplace/GetByTitle", {
//        method: "POST"
//    });
